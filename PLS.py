...
print(df[['elapsed_seconds', 'fluid_volume']])

smooth = signal.savgol_filter(df.iloc[:, 1:300], window_length=11, polyorder=2)
print(smooth.shape)
